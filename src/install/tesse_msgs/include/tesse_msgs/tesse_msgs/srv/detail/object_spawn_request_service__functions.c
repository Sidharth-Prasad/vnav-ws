...
tesse_msgs__srv__ObjectSpawnRequestService_Request__init(tesse_msgs__srv__ObjectSpawnRequestService_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->pose)) {
    tesse_msgs__srv__ObjectSpawnRequestService_Request__fini(msg);
    return false;
  }
  // params
...
tesse_msgs__srv__ObjectSpawnRequestService_Request__create()
{
  ...
  tesse_msgs__srv__ObjectSpawnRequestService_Request * msg = (tesse_msgs__srv__ObjectSpawnRequestService_Request *)allocator.allocate(sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Request));
  bool success = tesse_msgs__srv__ObjectSpawnRequestService_Request__init(msg);
  if (!success) {
...
tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__init(tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesse_msgs__srv__ObjectSpawnRequestService_Request * data = NULL;

  if (size) {
    data = (tesse_msgs__srv__ObjectSpawnRequestService_Request *)allocator.zero_allocate(size, sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tesse_msgs__srv__ObjectSpawnRequestService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tesse_msgs__srv__ObjectSpawnRequestService_Request__fini(&data[i - 1]);
      }
...
tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__fini(tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tesse_msgs__srv__ObjectSpawnRequestService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * array = (tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence *)allocator.allocate(sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__init(array, size);
  if (!success) {
...
tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__destroy(tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence__are_equal(const tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * lhs, const tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesse_msgs__srv__ObjectSpawnRequestService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesse_msgs__srv__ObjectSpawnRequestService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesse_msgs__srv__ObjectSpawnRequestService_Request * data =
      (tesse_msgs__srv__ObjectSpawnRequestService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesse_msgs__srv__ObjectSpawnRequestService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesse_msgs__srv__ObjectSpawnRequestService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesse_msgs__srv__ObjectSpawnRequestService_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesse_msgs__srv__ObjectSpawnRequestService_Response * msg = (tesse_msgs__srv__ObjectSpawnRequestService_Response *)allocator.allocate(sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Response));
  bool success = tesse_msgs__srv__ObjectSpawnRequestService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tesse_msgs__srv__ObjectSpawnRequestService_Response__destroy(tesse_msgs__srv__ObjectSpawnRequestService_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tesse_msgs__srv__ObjectSpawnRequestService_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__init(tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesse_msgs__srv__ObjectSpawnRequestService_Response * data = NULL;

  if (size) {
    data = (tesse_msgs__srv__ObjectSpawnRequestService_Response *)allocator.zero_allocate(size, sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tesse_msgs__srv__ObjectSpawnRequestService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tesse_msgs__srv__ObjectSpawnRequestService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__fini(tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tesse_msgs__srv__ObjectSpawnRequestService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * array = (tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence *)allocator.allocate(sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__destroy(tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence__are_equal(const tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * lhs, const tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesse_msgs__srv__ObjectSpawnRequestService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesse_msgs__srv__ObjectSpawnRequestService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesse_msgs__srv__ObjectSpawnRequestService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesse_msgs__srv__ObjectSpawnRequestService_Response * data =
      (tesse_msgs__srv__ObjectSpawnRequestService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesse_msgs__srv__ObjectSpawnRequestService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesse_msgs__srv__ObjectSpawnRequestService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesse_msgs__srv__ObjectSpawnRequestService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
